...
```{r Final inverse probability weighting creation, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
...
# positivity assumption portion
```{r positivey assumption graph, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
set.seed(16)
...
# marginally adjusted marginal standardization portion 

```{r marginally adjusted marginal standardizaton model, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
...
\noindent{ \bf Question 2}: Please interpret the results (i.e., risk difference) of the analyses in question 1.
...
\noindent{ \bf Question 6}: Consider a dataset with the following variables:
...
\noindent{ \bf Question 7}: Suppose we were interested in estimating the **conditionally adjusted risk difference** for the relation between aspirin and live birth. Describe three strategies you can use (including variance estimation) to do this with the aspirin data.
...
\noindent{ \bf Question 8}: Pick one of the methods from question 8, and implement it in the aspirin data. Include the **conditionally adjusted risk difference** and appropriate 95% confidence intervals.

...
ggplot(s1q2) + geom_linerange(aes(y = 0, xmin = -5, xmax = -3)) + geom_point(aes(x=-3, y=0)) +  scale_x_continuous(name="Year", limits=c(-5, 5))+ scale_y_continuous(name="ID", limits=c(0, 3)) +labs(
